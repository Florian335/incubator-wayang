...
public class StandaloneAPI {
    ...
    private static String hubspotToken;
        ...
        public static void logtoJSON(String stepname, Double latencyseconds, Double executiontime, String apiurl) {
            try {
        ...
        public static void logQueryTime(long starttime, long endtime, String stepname, String apiurl){
            ...
            logtoJSON(stepname, null, executiontimeseconds,apiurl);
        }
        ...
        public static void logAPIlatency(long starttime, long endtime, String stepname, String apiurl) {
            ...
            logtoJSON(stepname, latencyseconds,null, apiurl);
        }
            ...
            for (int i = 0; i < response.length(); i++) {
                ...
                if (allowedRoles.contains(json.optString("Roles", ""))) {
                    ...
                    try {
                        ...
                        logger.error("Invalid number for Dec 2024: " + dec2024Str, e);
                        fte = 0.0f;
                    }
    ...
    private static double HubspotPipelinePOSTTEST(String urlHubspot, String monthToday) {
        ...
        try {
            while (moreResults) {
                ...
                StandaloneAPI api = new StandaloneAPI(urlHubspot, apiMethod, headers, payload);
            ...
            for (JSONObject obj : allProperties) {
                if (obj.has("start_date") && obj.has("end_date") && obj.has("fte_s_")) {
