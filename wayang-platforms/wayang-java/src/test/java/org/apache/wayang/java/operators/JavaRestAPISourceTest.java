...
public class JavaRestAPISourceTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(JavaRestAPISourceTest.class);
    ...
    public void testFetchDataFromAPI() throws Exception {
        ...
        logger.info("JSON response successfully fetched. Length: {}", jsonResponse.length());
        ...
        for (int i = 0; i < jsonResponse.length(); i++) {
            ...
            // logger.info("Post {} validated: {}", i, post);
        }
    }
}
